import { Flex, Link, StyledCard } from '../styled/Core.styled';
import Typography from './Typography';

const RepoCard = ({ item, width, padding, bg, margin }) => {
	return (
		<>
			<StyledCard width={width} padding={padding} bg={bg} margin={margin}>
				...
				<Flex direction='row' alignItems='center' justifyContent='space-between' margin='20px 0 0 0'>
					{item.homepage && (
